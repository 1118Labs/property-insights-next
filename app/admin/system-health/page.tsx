  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#021C36]/90 via-[#0c2a49] to-[#04152b] px-6 py-10 text-slate-50">
      <div className="mx-auto max-w-5xl space-y-4">
        <div>
          <div className="text-xs uppercase tracking-[0.2em] text-white/60">Admin</div>
          <h1 className="text-3xl font-bold text-white">System Health</h1>
          <p className="text-sm text-white/70">Overview of accounts and daily usage.</p>
        </div>
        ...
        {/* Usage */}
        <div className="rounded-3xl border border-white/15 bg-white/10 p-6 shadow-xl shadow-black/30 backdrop-blur">
          <h2 className="text-xl font-semibold text-white mb-4">Usage (last 30 days)</h2>
